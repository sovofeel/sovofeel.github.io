  ...
  return (
    <section className="snap-section flex flex-col items-center justify-center px-6 ">
      ...
      <div className="w-full max-w-xl rounded-xl overflow-hidden border-2 border-[#d3c1ad] shadow-lg">
        <iframe
          src="https://yandex.ru/map-widget/v1/?ll=55.870480%2C54.710497&mode=search&ol=geo&z=18"
          width="100%"
          height="280"
          frameBorder="0"
  ...
  return (
    <Section>
      ...
      <p className="text-[#5C4A3A] text-base text-center leading-relaxed mb-6 max-w-[320px] mx-auto">
        Дорогие, мы очень старались сделать этот праздник особенным и красивым. Будем рады, если вы поддержите атмосферу, выбрав наряды в цветах нашей свадьбы: зелёный, голубой, коричневый, бежевый.
      </p>
